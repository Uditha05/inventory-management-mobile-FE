...
void main() {
  ...
  group('fetch items',(){
    test('returns items if the http call complete succesfully',()async {
      ...
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/checkAvaiability'))).thenAnswer((_) async=>
    ...
    test('trows an expection',()async{
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/checkAvaiability'))).thenAnswer((_) async=> http.Response('Not Found',404));
      expect(await lecturerApi.getItems(), isA<AvailabilityDetailList>());
    });
  });
  ...
  group('fetch pending requests',(){
    test('returns pending requests if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/pending'))).thenAnswer((_) async=>
      ...
      expect(await lecturerApi.getPendingRequest(),isA<RequestsList>());
    });
  ...
  group('fetch pending item details',(){
    test('returns pending item details if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/requestDetail/3'))).thenAnswer((_) async=>
  ...
  group('fetch avilable category details',(){
    test('returns available category details if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/category'))).thenAnswer((_) async=>
    ...
    test('trows an expection',()async{
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/category'))).thenAnswer((_) async=> http.Response('Not Found',404));
      expect(await lecturerApi.getCategory(), isA<List>());
    });
  });
  ...
  group('fetch models for a particular category',(){
    test('returns models for a particular category if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/model/camera'))).thenAnswer((_) async=>
    ...
    test('trows an expection',()async{
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/model/camera'))).thenAnswer((_) async=> http.Response('Not Found',404));
      expect(await lecturerApi.getModel('camera'), isA<List>());
    });
  });
  ...
  group('fetch laboratory for a given category and model',(){
    test('returns laboratory for a given category and model if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/lab/camera/RT567-R'))).thenAnswer((_) async=>
          http.Response('[{"Lab.labName":"CSE Level 1"}]',200));
      expect(await lecturerApi.getLab('camera', 'RT567-R'),isA<List>());
    });

    test('trows an expection',()async{
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/lab/camera/RT567-R'))).thenAnswer((_) async=> http.Response('Not Found',404));
      expect(await lecturerApi.getLab('camera', 'RT567-R'), isA<List>());
    });
  });
  ...
  group('fetch storeCode for a given category and model and laboratory',(){
    test('returns storeCode for a given category and model if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/storeCode/camera/RT567-R/cse%20level%201'))).thenAnswer((_) async=>
  ...
  group('fetch lecturers assigned for a laboratory',(){
    test('returns lecturers assigned for a laboratory if the http call complete succesfully',()async {
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/lecturer/cse%20level%201'))).thenAnswer((_) async=>
    ...
    test('trows an expection',()async{
      final client = MockClient();
      when(client.get(Uri.parse('https://sep-backend-inventory.herokuapp.com/lecturer/cse%20level%201'))).thenAnswer((_) async=> http.Response('Not Found',404));
      expect(await lecturerApi.getLecturers('cse level 1'), isA<List>());
    });
  });
