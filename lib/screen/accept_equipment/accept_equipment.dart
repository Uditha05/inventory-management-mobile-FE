...
class _AcceptEquipmentFormState extends State<AcceptEquipmentForm> {
  ...
  Iteam iteam;
  bool isIDVailed;
  List addUpdateTypes = ["Not Damaged", "Damage"];
  String addUpdateType = "Not Damaged";
  ...
  void SetCatogoryModel(Iteam iteam) async {
    ...
    setState(() {
      ...
      studentIdController.text = borrowData.status;
                ...
                ? Row(
                    ...
                    children: [
                      Container(
                        child: CustomButton(
                          onPressed: () =>
                              onChangeStoreCode(storeCodeController.text),
                          text: "Next",
                        ),
                      ),
                      SizedBox(
